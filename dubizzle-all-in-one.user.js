// ==UserScript==
// @name         Dubizzle – All In One (Smart Info)
...
// @updateURL    https://raw.githubusercontent.com/Khaledonline/pricelist/refs/heads/main/dubizzle-all-in-one.user.js
// @downloadURL  https://raw.githubusercontent.com/Khaledonline/pricelist/refs/heads/main/dubizzle-all-in-one.user.js
// @grant        none
...
(function () {
    ...
    function displayCarInfo() {
        const basicInfoHeader = Array.from(document.querySelectorAll('h3'))
            .find(h => h.textContent.trim().toLowerCase().includes('basic information'));
        if (!basicInfoHeader) return;
        
        // Prevent duplicate injection
        if (basicInfoHeader.nextElementSibling && basicInfoHeader.nextElementSibling.innerHTML.includes("Make:")) return;
